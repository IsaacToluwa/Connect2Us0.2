...
namespace WebApplication1.Controllers
{
    public class DatabaseController : Controller
    {
        ...
        public DatabaseController(IEmailService emailService)
        {
        ...
        {
            // CreateAdminUser(); // Commented out for now
            return View();
        }
        ...
        //                 Country = "Canada"
        //             };
        //             var adminPassword = System.Web.Security.Membership.GeneratePassword(12, 1);
        //             var adminResult = await userManager.CreateAsync(adminUser, adminPassword);
        //             if (adminResult.Succeeded)
        //             {
        //                 await userManager.AddToRoleAsync(adminUser, "Admin");
        //                 await _emailService.SendAdminAccountDetailsAsync(adminUser, adminUser.UserName, adminPassword);
        //             }
        //         }
        //     }
        // }
